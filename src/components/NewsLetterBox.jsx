  ...
  return (
    <div className='text-center'>
        ...
        <form onSubmit={onSubmitHandler} className='w-full sm:w-1/2 flex items-center gap-3 mx-auto my-6 border pl-3'>
            <input name='email' autoComplete='aditya' className='w-full sm:flex-1 outline-0 ' type="email" placeholder='Enter your Email' value={email} onChange={(e) => setEmail(e.target.value)} required/>
